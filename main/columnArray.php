...
$queryStudent = 'SELECT Student_Name FROM sheet1 ORDER BY Percentage DESC LIMIT 5';
...
$queryPercent = 'SELECT `Percentage` FROM sheet1 ORDER BY Percentage DESC LIMIT 5';
