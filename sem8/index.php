...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Department', 'Passing'],
          ['IOE',   <?php echo $resultIT;?>],
          ['BDA',   <?php echo $resultCS;?>],
          ['ERP', <?php echo $resultEXTC;?>],
          ['IRS', <?php echo $resultElec;?>],
          ['EM',  <?php echo $resultMech;?>]
        ]);
  ...
  <body>
		...
		<div class="wrapper d-flex align-items-stretch">
	        ...
	        <ul class="list-unstyled components mb-5">
	          <li>
	              <a href="../sem1/index.php">Semester One</a>
	          </li>
            <li>
	              <a href="../sem2/index.php">Semester Two</a>
	          </li>
            <li>
	              <a href="../sem3/index.php">Semester Three</a>
	          </li>
            <li>
	              <a href="../sem4/index.php">Semester Four</a>
	          </li>
            <li>
	              <a href="../sem5/index.php">Semester Five</a>
	          </li>
            <li>
	              <a href="../sem6/index.php">Semester Six</a>
	          </li>
            <li>
	              <a href="../sem7/index.php">Semester Seven</a>
	          </li>
            <li>
	              <a href="index.php">Semester Eight</a>
	          </li>
	      </div>
    	</nav>
